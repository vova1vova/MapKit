 ...
 */
public class SupportNokiaMapFragment extends SupportMapFragment implements SnaprixMapFragment {
    ...
    private NokiaGoogleMap mMap;
    private View mOriginalView;

    private MapFragmentInteractionListener mListener;

    public SupportNokiaMapFragment(){
        mMap = new NokiaGoogleMap(){

            @Override
            protected GoogleMap getMap(String method) throws MapException{
                GoogleMap map = SupportNokiaMapFragment.this.getMap();
                if (map == null){
